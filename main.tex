...
\usepackage{tabularx}   % para tablas que se ajustan a \linewidth
...
\usepackage[
    backend=biber,
    style=ieee,      % Para que salga [1], [2]
    natbib=true,
    maxcitenames=2,
    mincitenames=1   % <--- ¡ESTA LÍNEA ES LA CLAVE QUE TE FALTA!
]{biblatex}
